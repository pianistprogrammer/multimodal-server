...
class MultimodalProcessor:
    ...
    async def generate(self, text):
        ...
        async with self.lock:
            logger.info(f"Generating multimodal response")
            try:
                ...
                system_prompt = (
                    ...
                    "Keep your answers concise, fluent, and conversational. Use natural oral language that's easy to listen to. "
                    ...
                    "Ask the user to repeat or clarify if the request content is not clear or broken."
                )
